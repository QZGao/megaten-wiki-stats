...
function p.renderTop(ctx, result)
    ...
    local isP3Affinity = gameg == "p3" or gameg == "p3re"
    local isP5Affinity = gameg == "p5" or gameg == "p5r" or gameg == "p5s" or gameg == "p5x"
    if gameg == "ronde" or isP3Affinity or gameg == "p4" or isP5Affinity or gameg == "metaphor" then
        if prop.sword or prop.strike or prop.pierce or prop.phys or prop.fire or prop.ice or prop.elec or prop.wind or prop.expel or prop.dark or prop.alm or prop.down or prop.dizzy or prop.freeze or prop.paralyze or prop.poison or prop.charm or prop.distress or prop.panic or prop.fear or prop.rage or prop.xp or prop.yen then
            ...
            if gameg == "ronde" or isP3Affinity then
            ...
            if isP3Affinity or gameg == "p4" or isP5Affinity or gameg == "metaphor" then affinity_table = affinity_table .. styles.statlow .. prop.wind end
            if isP5Affinity then affinity_table = affinity_table .. styles.statlow .. prop.psy .. styles.statlow .. prop.nuclear end
...
function p.renderPost(ctx, result)
    ...
    local isPq = gameg == "pq"
    if isPq or (gameg == "pq2" and (prop.sword or prop.pierce or prop.strike or prop.phys or prop.fire or prop.water or prop.elec or prop.wind or prop.nuclear or prop.psy or prop.expel or prop.dark or prop.alm or prop.ko or prop.sleep or prop.panic or prop.poison or prop.paralyze or prop.down or prop.stbind or prop.mabind or prop.agbind)) then
        result = result .. styles.table2
        prop.sword = prop.sword or "-"
        prop.pierce = prop.pierce or "-"
        prop.strike = prop.strike or "-"
